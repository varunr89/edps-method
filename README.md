...
│   ├── wealth-of-nations/          # Each book has its own folder (slug name)
│   │   ├── meta.yaml               # Book metadata
│   │   ├── sections.yaml           # Section breakdown (generated by ingest)
...
│   ├── leviathan/                  # Another book...
│   └── capital-vol-1/              # Another book...
